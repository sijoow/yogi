    ...
    <section id={id} ref={ref} className="BrandSection_03">
      <div className="ps3-wrap">
        ...
        <div className="ps3-text">
          ...
          <p className="ps3-p">
                <strong>SallyFeel is</strong> the first "Well-Living" brand, inspired by the belief that good things happen—even by chance.<br/> We aim to bring moments of delightful serendipity into everyday life. 
